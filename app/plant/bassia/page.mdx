...
Kochia gets twiggy (but not thorny) as it sets seed. Its tiny green flowers can be stripped from the stems for cooking like those of its relative [quelites](chenopodium).
